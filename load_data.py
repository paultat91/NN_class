...
# MY NEURAL NETWORK
Neural = NN(hidden_layer_size=10, activation='logistic', learning_rate=.1, max_iter=1000)
...
model = MLPClassifier(hidden_layer_sizes=(10), activation='logistic', learning_rate_init=.1, max_iter=1000, solver='lbfgs')
