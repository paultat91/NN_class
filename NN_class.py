...
class NN(object):
    ...
    def __init__(self, learning_rate, lessons, activation='sigmoid'):
    ...
    def train_test(self, x, y):
        ...
        self.initial_weights = np.random.rand(1,len(x[1])+len(y[1])) 
        self.final_weights = []     
        ...
        W_hh = np.expand_dims(self.initial_weights[0,0:len(x[1])], axis=1).T
